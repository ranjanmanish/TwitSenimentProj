...
def fetchsamples(List):
  ...
  url  = 'http://search.twitter.com/search.json?q=YPD2 &rpp=100&page=10&result_type=recent&since=2013-06-07&until='+today
  #url = "http://search.twitter.com/search.json?q="+List[0]+" OR #"+List[2]+" AND review&rpp=100&page=20&since="+List[1]+"&until="+today+"&result_type="+List[3]
  parameters = []
